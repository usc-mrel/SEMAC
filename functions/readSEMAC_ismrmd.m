...
for nF = 1:length(h5_fullpath)
    ...
    if flags.Squeeze
        ...
        kdata{nF} = reshape(kdata{nF},[info{nF}.rawData.nr_samples, info{nF}.Ny,  info{nF}.rawData.nr_slice_encodings, info{nF}.rawData.nr_slices, info{nF}.rawData.nr_channels]);
